        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-5">
            <p className="text-sm text-amber-800 leading-relaxed">
              Cette page est en cours de rédaction. PharmaVig Maroc traite les données conformément à la
          ...
          <p className="text-sm text-gray-500 mt-6">
            ...
            <a href="mailto:contact@pharmavig.ma" className="text-emerald-700 underline font-medium">contact@pharmavig.ma</a>.
          </p>
        </div>
      </main>
    </div>
