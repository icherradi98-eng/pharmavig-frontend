  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      <header className="border-b border-gray-100 px-6 md:px-10 py-4 flex items-center justify-between">
        <Link href="/" className="font-bold text-lg text-emerald-700">MAIA DAWA</Link>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-5">
            <p className="text-sm text-amber-800 leading-relaxed">
              Cette page est en cours de rédaction. MAIA DAWA traite les données conformément à la
