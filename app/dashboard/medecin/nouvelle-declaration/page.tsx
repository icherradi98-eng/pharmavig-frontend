...
import { FieldLabel, Input, Select, Textarea, RadioGroup, CheckRow, SectionTitle, Collapsible, Grid, Field } from "./components/FormPrimitives";
import { MedDRASearch } from "./components/MedDRASearch";
import { TypeDeclarationInline } from "./components/TypeDeclarationInline";
import { MedicamentSearch, type DrugEnrichment } from "./components/MedicamentSearch";
import type { FormData, MedicamentConcomitant } from "@/lib/declaration/types";
import { DRAFT_KEY, INITIAL, SECTIONS, FORMES, VOIES, STADES_RENALE, STADES_HEPATIQUE } from "@/lib/declaration/constants";
